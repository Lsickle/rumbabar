...
<div class="container shadow rounded border border-3 h-90 bg-white">
	<form action="{{route('proveedors.update', [$proveedor])}}" method="POST" enctype="multipart/form-data">
		@csrf
		@method('PUT')
		<div class="row justify-content-between py-2 my-2" id='proveedorHeader'>
						...
						<div class="card-body">
							<div class="form-group">
								<div class="input-group">
									...
									<input required value="{{$proveedor->ProveedorNombre}}" name="ProveedorNombre" type="text" class="form-control" placeholder="razón social" aria-label="nombre" aria-describedby="basic-addon1">
								</div>
							</div>
							<div class="form-group">
								<div class="input-group">
									...
									<input required value="{{$proveedor->ProveedorNit}}" name="ProveedorNit" type="number" class="form-control" placeholder="NIT" aria-label="NIT" aria-describedby="basic-addon1">
								</div>
							</div>
						</div>
					</div>
