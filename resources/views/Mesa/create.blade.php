...
<div class="sticky-top px-3 mt-2">
    <div class="row bg-light">
        <div class="col">
            <p class="float-left text-secondary text-uppercase font-inter-700" style="font-size:13px;">{{'Nueva Mesa'}}</p>
        </div>
        <div class="col">
...
<div class="container shadow rounded border border-3 h-90 bg-white">
    <form action="{{route('mesas.store')}}" method="POST" id="createMesaForm">
        @csrf
        <div class="row justify-content-between py-2 my-2" id='mesasCreateHEader'>
            ...
            <div class="col-6 my-2 col-md-4">
                <input type="submit" class="float-right btn btn-primary text-white font-inter-600" style="font-size:12px;" value="+ Guardar">
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input name="MesaPuestos" type="number" class="form-control" placeholder="Número de Puestos" aria-label="Número de Puestos" aria-describedby="basic-addon1">
                                </div>
                            </div>
                        </div>
                    </div>
