            ...
            <table id="productsTable" class="table table-hover table-sm text-left mb-0" style="color:#6E6893 !important;">
                <thead class="font-inter-600" style="background-color: #F4F2FF;">
                    <tr>
                        ...
                        <th id="th-4" scope="col">Documento</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-middle" scope="col">
                            <div class="text-nowrap">
                                <div class="text-dark">${{$cliente->ClienteDocumento}}</div>
                            </div>
                        </td>
                        <td class="align-middle text-center" scope="col">
                            <div class="text-nowrap">
                                <div class="text-dark">{{$cliente->ProductoCantidad}}</div>
                            </div>
                        </td>
                        <td class="align-middle" scope="col">
                            <div class="text-nowrap">
                        ...
                        <td class="align-middle text-right" scope="col">
                            <a href="{{route('clientes.edit', ['cliente' => $cliente->ClienteId])}}" class="btn btn-sm btn-warning">
                                <div class="text-nowrap">Editar</div>
                            </a>
                        </td>
                        <td class="align-middle text-right" scope="col">
                            <form method="POST" id="formDestroy{{$cliente->ClienteId}}" action="{{route('clientes.destroy', ['producto' => $cliente->ClienteId])}}">
                                @csrf
                                @method('DELETE')
