					...
					<div class="row">
						<div class="form-group col-md-6">
							...
							<select class="form-control" id="inputGroupSelect02" name="ClienteTipoDoc">
								...
								<option class="text-nowrap bd-highlight" value="TI">Tarjeta de Identidad</option>
								<option class="text-nowrap bd-highlight" value="PP">Pasaporte</option>
								<option class="text-nowrap bd-highlight" value="OTRO">Otro</option>
							</select>
						</div>
