...
<div class="sticky-top px-3 mt-2">
    <div class="row bg-light">
        <div class="col">
            <p class="float-left text-secondary text-uppercase font-inter-700" style="font-size:13px;">{{'Nuevo Rol'}}</p>
        </div>
        <div class="col">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input required name="RolNombre" type="text" class="form-control" placeholder="nombre" aria-label="nombre" aria-describedby="basic-addon1">
                                </div>
                            </div>
                        </div>
                    </div>
