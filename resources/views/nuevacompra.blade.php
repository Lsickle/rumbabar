...
<head>
    ...
    <title>Registro de compra - Rumbabar</title>
        ...
        <div class="container">
            ...
            <div class="container shadow rounded border border-3 h-90 bg-white">
                <div class="row justify-content-between py-2 my-2" id='ventasHeader'>
                    ...
                    <div class="col-6 my-2 col-md-3">
                        <button class="float-right btn btn-primary text-white font-inter-600" style="font-size:12px;"><b>+ Nuevo Producto</b></button>
                    </div>
